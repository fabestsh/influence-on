...
<head>
  ...
  <style>
    ...
    .dashboard-header .button.button-primary {
      display: inline-flex;
      align-items: center;
  ...
  <main class="dashboard">
    <div class="container">
      <div class="dashboard-header">
        <div>
          <h1 class="welcome-text">Welcome, Business!</h1>
          <p class="text-secondary">Manage your influencer marketing campaigns</p>
        </div>
        <a href="create_campaign.php" class="button button-primary">Create New Campaign</a>
      </div>
